        ...
        <header className="bg-white border-b">
            <div className="c_container relative py-3">
                <nav className="flex items-center justify-between">
                    ...
                    <div className={`absolute left-5 bg-white border p-5 transition-all delay-100 z-50 ${open === true ? 'opacity-100 visible top-full' : 'opacity-0 invisible top-16'} md:static md:bg-none md:border-0 md:p-0 md:left-10 md:visible md:opacity-100`}>
